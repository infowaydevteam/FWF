...
return (
  ...
  >
    ...
    <div className="flex-grow">
      <div className="hidden md:block w-full h-64 md:h-80 lg:h-96 mt-[100px] overflow-hidden rounded-3xl mx-auto px-4 md:px-8">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <img src="/aboutimage.jpg" alt="About Us" className="w-full h-full object-cover rounded-3xl shadow-2xl mobile:mt-5" />
        </motion.div>
